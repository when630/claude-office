...
- Hold **`Ctrl+Shift`** and you can order them about — the pointer picks up a mint outline while
  you do. **Drag a box** and every crab caught in it gets a crescent under its feet while you are
  still drawing; let go and a bracket snaps shut on each one in turn — in the direction you
  dragged — leaving a ring at its feet. **Right-click** to send them somewhere and an arrow drops
  onto that spot, with the crabs spreading out rather than piling on one. Click empty space to
  clear, and let go of the keys and the sheet goes back to letting your clicks through. One that
  is working folds its laptop, walks over, and **opens it again on arrival**
